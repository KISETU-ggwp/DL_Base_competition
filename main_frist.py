...
def plot_learning_curves(train_losses, train_scores, val_losses, val_scores):
    ...
    # Score curve
    plt.subplot(1, 2, 2)
    plt.plot(epochs, train_scores, 'b-', label='Training VQA Score')
    plt.plot(epochs, val_scores, 'r-', label='Validation VQA Score')
    plt.title('Training and Validation VQA Score')
    plt.xlabel('Epochs')
    plt.ylabel('VQA Score')
    plt.legend()
